...
const findGenres = (genreMovieList: Array<Genres>, movieGenreIds: Array<Number>): Array<Genres> => {
...
export const displayGenresNames = (genreMovieList: Array<Genres>, movieGenreIds: Array<Number>): string => {
